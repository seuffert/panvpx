...
- **Never manually edit `ffi/` generated files**: Files under `org.seuffert.panvpx.ffi` are auto-generated by jextract. Manual edits will be lost on the next regeneration. If a compile error or static-analysis warning surfaces inside `ffi/`, verify that the exclusion rules in `build.gradle.kts` cover it — do not touch the generated source.
